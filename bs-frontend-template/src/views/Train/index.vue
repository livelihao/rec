<template>
    <el-card class="x-container">
        <div slot="header" class="header">
            <span class="header-title">模型训练</span>
        </div>
        <el-row :gutter="20" class="training-row" style="margin-top: 20px;">
            <el-col :span="12">
                <el-card shadow="hover" style="height: 40vh;">
                    <div class="training-container">
                        <el-button type="primary" :loading="loadingNeuralCF" @click="trainNeuralCF">NeuralCF训练</el-button>
                        <div class="results" v-if="loadingNeuralCF">
                            <el-spinner></el-spinner>
                        </div>
                        <el-table :data="resultsNeuralCFTemp" style="width: 100%">
                            <el-table-column type="index" label="Epoch" width="150">
                            </el-table-column>
            ...
            <el-col :span="12">
                <el-card shadow="hover" style="height: 40vh;">
                    <div class="training-container">
                        <el-button type="primary" :loading="loadingTensorNet"
                            @click="trainTensorNet">TensorNet训练</el-button>
                        <div class="results" v-if="loadingTensorNet">
                            <el-spinner></el-spinner>
                        </div>
                        <el-table :data="resultsTensorNetTemp" style="width: 100%">
                            <el-table-column type="index" label="Epoch" width="150">
                            </el-table-column>
                            <el-table-column prop="MSE" label="MSE">
                            </el-table-column>
                        ...
                        <!-- <div v-if="!loadingTensorNet && !resultsTensorNet.res1.length" class="placeholder">No results to
                            display.</div> -->
                    </div>
                </el-card>
            </el-col>
